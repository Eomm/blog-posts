...
The first step is to create our database schema. Note that this section does not concern Platformatic itself,
...
Here we will remove all the files and copy the `001.do.schema.sql` and `002.do.data.sql` files we created in the
